...
import { activeNoticeTabStateStore } from '@/app/project/[slug]/_store/ActiveNoticeTabStateStore';
  ...
  return (
    ...
    >
      <ul role='list' className='mobile:hidden tablet:-mx-2 tablet:space-y-1'>
        {Object.values(PROJECT_NOTICE_TABS).map((v) => (
          <li key={v.code}>
            <div
      ...
      <div className='mobile:block hidden'>
        <Select
          items={Object.values(PROJECT_NOTICE_TABS).map((v) => ({
            name: v.name,
            value: v.code,
          }))}
          label=''
