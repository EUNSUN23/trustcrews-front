import PostConfigPositionsControl from '@/features/projectBoard/ui/projectConfigBoard/postInfoEditor/inputControl/PostConfigPositionsControl';
import PostConfigContactControl from '@/features/projectBoard/ui/projectConfigBoard/postInfoEditor/inputControl/PostConfigContactControl';
import PostConfigContentControl from '@/features/projectBoard/ui/projectConfigBoard/postInfoEditor/inputControl/PostConfigContentControl';
import ProjectPostInfoSaveButton from '@/features/projectBoard/ui/projectConfigBoard/postInfoEditor/PostConfigSaveButton';
import PostConfigRecruitStatusControl from '@/features/projectBoard/ui/projectConfigBoard/postInfoEditor/inputControl/PostConfigRecruitStatusControl';
import { useRecoilValue, useSetRecoilState } from 'recoil';
import { projectIdState } from '@/store/projectDetail/ProjectIdStateStore';
import PostConfigResetButton from '@/features/projectBoard/ui/projectConfigBoard/postInfoEditor/PostConfigResetButton';
...
import PostConfigTitleControl from '@/features/projectBoard/ui/projectConfigBoard/postInfoEditor/inputControl/PostConfigTitleControl';
