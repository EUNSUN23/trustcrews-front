...
import { useRCVoteNoticeList } from '@/features/projectNotice/api/rcVoteNotice/getRCVoteNoticeList';
import { useRecoilValue } from 'recoil';
import { projectIdState } from '@/store/projectDetail/ProjectIdStateStore';
import { numStrToBigInt } from '@/shared/utils/stringUtils';
import { ITEM_COUNT_PER_PAGE, PAGE_RANGE } from '@/constants/pagination';
import RCVoteNoticeItem from '@/features/projectDetail/ui/projectNoticeBoard/rcVoteNotice/RCVoteNoticeItem';
