...
import MilestoneAddButton from '@/features/projectDetail/ui/projectJobBoard/MilestoneAddButton';
import Milestones from '@/features/projectDetail/ui/projectJobBoard/milestones';
import { useMilestones } from '@/features/milestone/api/getMilestones';
import { useRecoilState, useRecoilValue, useResetRecoilState } from 'recoil';
import { projectIdState } from '@/store/projectDetail/ProjectIdStateStore';
import TaskAddButton from '@/features/projectDetail/ui/projectJobBoard/TaskAddButton';
import Tasks from '@/features/projectDetail/ui/projectJobBoard/tasks';
...
import MilestoneModModal from '@/features/projectDetail/ui/projectJobBoard/milestoneModal/MilestoneModModal';
import MilestoneAddModal from '@/features/projectDetail/ui/projectJobBoard/milestoneModal/MilestoneAddModal';
import TaskAddModal from '@/features/projectDetail/ui/projectJobBoard/taskModal/TaskAddModal';
import TaskModModal from '@/features/projectDetail/ui/projectJobBoard/taskModal/TaskModModal';
import TasksSkeleton from '@/features/projectDetail/ui/projectJobBoard/tasks/TasksSkeleton';
import { bigIntToString } from '@/shared/utils/stringUtils';
import FieldQueryBoundary from '@/lib/error/FieldQueryBoundary';

const { milestoneId: DEFAULT_MILESTONE_ID } = DEFAULT_ACTIVE_MILESTONE;

const ProjectJobBoard = () => {
  ...
  if (initActiveMilestone && activeMilestoneId === DEFAULT_MILESTONE_ID)
    return <ProjectJobBoardSkeleton />;
...
export default ProjectJobBoard;
