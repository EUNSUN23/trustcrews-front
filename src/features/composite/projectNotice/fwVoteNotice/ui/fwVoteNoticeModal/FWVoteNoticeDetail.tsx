...
import {
  ...
  useFWVoteNotice,
} from '@/features/composite/projectNotice/fwVoteNotice/api/getFWVoteNotice';
...
import { FWVOTE_NOTICE_LIST_QUERY_KEY } from '@/features/composite/projectNotice/fwVoteNotice/api/getFWVoteNoticeList';
