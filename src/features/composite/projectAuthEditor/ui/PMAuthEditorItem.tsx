...
} from '@/features/core/projectAuth/api/updateProjectMngAuth';
import PMAuthSelector from '@/features/core/projectAuth/ui/PMAuthSelector';
...
const PMAuthEditorItem = ({
  ...
  const handleClickSaveButton = () => {
    const data: UpdateProjectMngAuthInput = {
      crewPMAuth: auth.value,
    };

    try {
      updateProjectMngAuthInputSchema.parse(data);
    } catch (e) {
...
export default PMAuthEditorItem;
