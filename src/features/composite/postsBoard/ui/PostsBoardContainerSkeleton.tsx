import PostsTechStackFilterSkeleton from '@/features/composite/postsBoard/ui/postsTechStackFilter/PostsTechStackFilterSkeleton';
import CardListSkeleton from '@/shared/ui/skeleton/CardListSkeleton';
import Skeleton from '@/shared/ui/skeleton/Skeleton';
import PostsPositionFilterSkeleton from '@/features/composite/postsBoard/ui/postPositionFilter/PostsPositionFilterSkeleton';
    ...
    <section className='flex flex-col space-y-5'>
      ...
      >
        <div className='flex justify-start space-x-5 mr-auto'>
          <PostsTechStackFilterSkeleton />
          <PostsPositionFilterSkeleton />
        </div>
