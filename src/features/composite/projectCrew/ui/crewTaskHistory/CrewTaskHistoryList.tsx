...
import { useTaskHistory } from '@/features/core/taskHistory/api/getTaskHistory';
import { clsx } from 'clsx';
import { FaMinus } from '@react-icons/all-files/fa/FaMinus';
import { FaPlus } from '@react-icons/all-files/fa/FaPlus';
import { ITEM_COUNT_PER_PAGE, PAGE_RANGE } from '@/shared/constants/pagination';

type CrewTaskHistoryListProps = {
  crewId: bigint;
};

const CrewTaskHistoryList = ({ crewId }: CrewTaskHistoryListProps) => {
  ...
  } = useTaskHistory(crewId, pageIndex);
...
export default CrewTaskHistoryList;
