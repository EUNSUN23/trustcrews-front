...
import MilestoneModContentControl from '@/features/composite/projectJob/ui/milestoneModal/milestoneInputControl/MilestoneModContentControl';
import MilestoneModDateControl from '@/features/composite/projectJob/ui/milestoneModal/milestoneInputControl/MilestoneModDateControl';
import {
  updateMilestoneSchema,
  useUpdateMilestone,
} from '@/features/core/milestone/api/updateMilestone';
...
type MilestoneModModalProps = {
  userPMAuthCode: string;
};

const MilestoneModModal = ({ userPMAuthCode }: MilestoneModModalProps) => {
